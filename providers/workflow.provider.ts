...
// const workflowRepository = new WorkflowRepositoryInMemory();

// Instantiate use case with repository
export const getWorkflowsUseCase = new GetWorkflowsUseCase(workflowRepository);
export const createWorkflowUseCase = new CreateWorkflowUseCase(
  workflowRepository,
);
export const deleteWorkflowUseCase = new DeleteWorkflowUseCase(
  workflowRepository,
);
export const getWorkflowByIdUseCase = new GetWorkflowByIdUseCase(
  workflowRepository,
);
export const updateWorkflowUseCase = new UpdateWorkflowUseCase(
  workflowRepository,
);
