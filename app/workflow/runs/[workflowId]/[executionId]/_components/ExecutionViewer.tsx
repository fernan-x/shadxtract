        ...
        <div className="py-4 px-2">
          <div className="flex justify-between items-center py-2 px-4 text-sm">
            <div className="text-muted-foreground flex items-center gap-2">
              <CircleDashedIcon size={20} className='stroke-muted-foreground/80' />
              <span>Status</span>
            </div>
            <div className="font-semi-bold capitalize flex gap-2 items-center">{query.data?.status}</div>
          </div>
          ...
          <div className='flex justify-between items-center py-2 px-4 text-sm'>
            ...
            <div className="font-semi-bold capitalize flex gap-2 items-center">
              {query.data?.startedAt ? query.data.startedAt.toLocaleString() : '-'}
            </div>
          </div>
        </div>
      </aside>
